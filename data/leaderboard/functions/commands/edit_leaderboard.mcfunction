...
$execute as @e[limit=1,sort=nearest,type=text_display,tag=top,tag=leaderboard] if score dummy dummy_1 matches $(medal_color) run tag @s add medal_color
$execute as @e[limit=1,sort=nearest,type=text_display,tag=top,tag=leaderboard] if score dummy dummy_0 matches $(medal_color) run tag @s remove medal_color
...
$execute as @e[limit=1,sort=nearest,type=text_display,tag=top,tag=leaderboard] if score dummy dummy_1 matches $(always_show_closest_player) run tag @s add always_show_closest_player
$execute as @e[limit=1,sort=nearest,type=text_display,tag=top,tag=leaderboard] unless score dummy dummy_1 matches $(always_show_closest_player) run tag @s remove always_show_closest_player
