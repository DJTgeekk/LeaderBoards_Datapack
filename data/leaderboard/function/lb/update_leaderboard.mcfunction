...
execute as @s if score lb_temp temp_max matches 1 unless score lb_temp temp_rank > lb_temp namelist_size run function leaderboard:lb/add_line_prep with storage leaderboard:line
execute as @s if score lb_temp temp_max matches 1 if score lb_temp temp_rank > lb_temp namelist_size run function leaderboard:lb/remove_extra_line with storage leaderboard:line
execute as @s if score lb_temp temp_max matches 0 run function leaderboard:lb/remove_extra_line with storage leaderboard:line