...
data merge storage leaderboard:init_edit {score:score_name,display_name:"LeaderBoard Title",max_players:8,reverse_order:0,no_zero:0,medal_color:0,always_show_closest_player:1,billboard:"vertical",time_mode:0,see_through:0,bright:-1}
