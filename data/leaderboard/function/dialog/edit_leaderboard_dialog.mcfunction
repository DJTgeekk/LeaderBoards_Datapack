...
execute store result score data_d.billboard_length data_d run data get storage leaderboard:init_edit billboard
execute store success storage leaderboard:init_edit vertical_init byte 1 if score data_d.billboard_length data_d matches 8
execute store success storage leaderboard:init_edit horizontal_init byte 1 if score data_d.billboard_length data_d matches 10
execute store success storage leaderboard:init_edit fixed_init byte 1 if score data_d.billboard_length data_d matches 5
